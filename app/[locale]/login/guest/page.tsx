    ...
    <div className="d-flex justify-content-center align-items-center vh-100" style={{ background: "linear-gradient(135deg, #1e293b 0%, #334155 100%)" }}>
      ...
      <div className="card border-0 shadow-lg p-4" style={{ width: "400px", borderRadius: "12px" }}>
        <div className="text-center mb-4">
          <div className="bg-warning text-white d-inline-flex align-items-center justify-content-center rounded-circle mb-3" style={{ width: "60px", height: "60px" }}>
            <i className="bi bi-eye fs-3"></i>
          </div>
          <h3 className="fw-bold">Guest Access</h3>
          <p className="text-muted small">Access company data based on assigned permissions</p>
        </div>
        ...
        <form onSubmit={login}>
          ...
          <div className="mb-3">
            ...
            <div className="input-group">
              ...
              <input className="form-control" placeholder="Guest email" value={email} onChange={e => setEmail(e.target.value)} required />
            </div>
          </div>
          ...
          <button type="submit" className="btn btn-warning w-100 py-2 fw-semibold text-dark" disabled={loading}>
            {loading ? (
